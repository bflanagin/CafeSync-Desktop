        ...
        Column {
           ...
           // height:parent.height * 1.2
            ...
            Item {
                ...
                Rectangle {
                  ...
                  //  anchors.topMargin: parent.height * 0.02
                    ...
                    anchors.centerIn: parent
                    width:parent.width * 0.98
                    height:actions.height + info.height + popup.width * 0.06
                    //clip:true
                    visible: false
                    ...
                    Row {
                        ...
                        Column {
                            ...
                            Text {
                                ...
                                font.pixelSize: popup.width * 0.063
                            }
                            Rectangle {
                                width:parent.width
                                height:3
            ...
            Item {
                anchors.horizontalCenter: parent.horizontalCenter
                width: parent.width * 0.98
                height:statuscontent.height + popup.width * 0.04
                        ...
                        TextField {
                           ...
                           // text:MicroBlog.latest_log("mycard",cardId)
                            ...
                            Image {
                                ...
                                anchors.right:parent.right
                                anchors.rightMargin: popup.width * 0.02
                                anchors.verticalCenter: parent.verticalCenter
                                width: popup.width * 0.06
                                height:popup.width * 0.06
            ...
            Item {
                anchors.horizontalCenter: parent.horizontalCenter
                width: parent.width * 0.98
                height:statscontent.height  + popup.width * 0.04 // + eventbox.height
                visible: if( cardusername == username) {true} else {false}

              /*  Rectangle {
                    id:eventbox
                    width:parent.width * 0.98
                    height:eventcontent.height + popup.width * 0.04
                    //anchors.centerIn: parent
                    anchors.horizontalCenter: parent.horizontalCenter
                    color:cardcolor
                    ...
                    Column {
                        ...
                        ListView {
                            id:events
                            width:parent.width
                            height:(popup.width * 0.11) * model
                            spacing: popup.width * 0.02
                            model: 0
                ...
                Rectangle {
                    id:statsbox
                    width:parent.width * 0.98
                    height:statscontent.height + popup.width * 0.04
                  //  anchors.top:eventbox.bottom
                  //  anchors.topMargin:popup.width * 0.04
                    anchors.horizontalCenter: parent.horizontalCenter
                    ...
                    Column {
                        ...
                        Grid {
                            id:statRow
                            anchors.horizontalCenter: parent.horizontalCenter
                            spacing: popup.width * 0.01
                            width:parent.width * 0.98
                            clip:true

                            CircleStat {
                                width:popup.width * 0.22
                                height:popup.width * 0.22

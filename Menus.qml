...
Item {
 ...
 DropShadow {
    ...
    ListView {
        ...
        anchors.topMargin: thisWindow.width * 0.04
        ...
        delegate: Item {
            ...
            MouseArea {
                ...
                onClicked:switch(menuitem) {
                          ...
                          case "1":requestPage.state = "InActive";
                                   messagePage.state = "InActive";
                                    settingsPage.state = "InActive";cardPage.state = "show";cardPage.state = "default";currentcard = -1;currentcard_username = username;
                                            ...
                                            cardindex = 0;
                                            pagelist.clear();Scripts.show_Sites("local",userid);mainScreen.state = "Active";mainScreen.fromRequest = false;thisWindow.state = "InActive";mainScreen.positionViewAtBeginning();gc();
                                            currentcard_saved = 2;
                          ...
                          case "3": /* chatPage.state = "Available",thisWindow.state = "InActive";topBar.isActive = false;topBar.state = "chat";*/break;
                          case "4": messagePage.from =="Menu",messagePage.state = "Active",thisWindow.state = "InActive";topBar.isActive = false;topBar.state = "messages";break;
                          case "5": messagePage.state = "InActive", requestPage.state = "Active",thisWindow.state = "InActive";topBar.isActive = false;topBar.state = "requests";break;
                          case "6": /* eventsPage.state = "Available",thisWindow.state = "InActive";topBar.isActive = false;topBar.state = "events"; */break;
                          ...
                          default:if(title == "Category") {currentcat = menuitem;
                                                                    cardslist.clear();
                                                                       if (selection == 0) {
                                                                        ...
                                                                        } else {usercat = menuitem;} thisWindow.state = "InActive",mainMenu2.rotation = 0;break;
                          }

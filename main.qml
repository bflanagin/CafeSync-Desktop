...
Government::brown,Law::maroon,Living::darkgreen,Lifestyle::pink,Music::darkblue,Non-Profit::merrygold,Personal::none,Repair::darkred,Science::blue,Software::orange,Technology::darkorange,Theatre::none,Writing::none,Wellness::lightpink"
   ...
   height:Screen.desktopAvailableHeight
    ...
    title: "CafeSync: Home Base"
    property bool hmode: false
...
Component.onCompleted: {if(width > height) {hmode = true;} else {hmode = false;} }
              ...
              /*  Image {
               ...
               /* Image {
                ...
                GridView {
                    ...
                    flow: if(hmode == false) { GridView.FlowLeftToRight } else {GridView.FlowTopToBottom}
                   ...
                   // spacing: passerbyGrid.width * 0.08
                    ...
                    delegate: Item {
                                ...
                                width: if(hmode == false) {passerbyGrid.cellWidth * 0.98} else {passerbyGrid.cellWidth * 0.98}
                               // height: if(type != 9) {thecard.height} else {spacer.height}
                                height: passerbyGrid.cellHeight * 0.98
                               /* Rectangle {
                                    anchors.fill:parent
                                    color:"green"
                                } */
                        ...
                        Card {
                               id:thecard
                                visible: if(type != 9) {true} else {false}
                               // width: if(hmode == false) {parent.width * 0.96} else {parent.width * 0.96}
...
Wizard {
    id:firstrun
    width: if(hmode == false) {mainView.width} else {mainView.width * 0.38}
